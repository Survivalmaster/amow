...
use App\Http\Controllers\PlayerBusinessController;
...
Route::middleware(['auth', 'not_banned'])->group(function () {
    ...
    Route::middleware('character')->group(function () {
        ...
        Route::get('/businesses', [PlayerBusinessController::class, 'index'])->name('businesses.index');
        Route::post('/businesses', [PlayerBusinessController::class, 'store'])->name('businesses.store');
        Route::get('/businesses/{playerBusiness:slug}', [PlayerBusinessController::class, 'show'])->name('businesses.show');
        Route::post('/businesses/{playerBusiness:slug}/menu', [PlayerBusinessController::class, 'storeMenuItem'])->name('businesses.menu.store');
        Route::post('/businesses/{playerBusiness:slug}/roles', [PlayerBusinessController::class, 'storeRole'])->name('businesses.roles.store');
        Route::post('/businesses/{playerBusiness:slug}/invites', [PlayerBusinessController::class, 'invite'])->name('businesses.invites.store');
        Route::post('/businesses/{playerBusiness:slug}/join', [PlayerBusinessController::class, 'join'])->name('businesses.join');
        Route::post('/businesses/{playerBusiness:slug}/deposit', [PlayerBusinessController::class, 'deposit'])->name('businesses.deposit');
        Route::post('/businesses/{playerBusiness:slug}/withdraw', [PlayerBusinessController::class, 'withdraw'])->name('businesses.withdraw');
    ...
    Route::prefix('admin')->middleware('can:access-admin')->name('admin.')->group(function () {
        ...
        Route::post('/stock-market/companies', [StockMarketAdminController::class, 'storeCompany'])->middleware('admin.section:stock_market')->name('stock-market.companies.store');
