...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware('can:access-admin')->name('admin.')->group(function () {
        ...
        Route::delete('/characters/{character}', [CharacterAdminController::class, 'destroy'])->name('characters.destroy');
        ...
        Route::delete('/factions/{faction}', [FactionAdminController::class, 'destroy'])->name('factions.destroy');
        ...
        Route::delete('/cities/{city}', [CityAdminController::class, 'destroy'])->name('cities.destroy');
