        ...
        <section class="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 shadow-2xl shadow-black/30">
            ...
            <div class="divide-y divide-white/10">
                @forelse ($roles as $role)
                    <details class="group">
                        <summary class="grid cursor-pointer gap-4 px-5 py-4 transition hover:bg-white/[0.03] md:grid-cols-[minmax(0,1fr)_8rem_8rem_2rem] md:items-center">
                            <div class="min-w-0">
                                <div class="flex min-w-0 items-center gap-3">
                                    ...
                                    <span class="truncate font-semibold text-white">{{ $role->name }}</span>
                                    @if ($role->is_managed)
                                ...
                                <p class="mt-1 truncate text-xs text-white/40">Role ID {{ $role->discord_id }}</p>
                            </div>
                            ...
                            <i class="fa-solid fa-chevron-down text-right text-xs text-white/45 transition group-open:rotate-180"></i>
                        </summary>
