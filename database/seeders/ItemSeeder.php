...
class ItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['name' => 'Salvaged Shelter Kit', 'slug' => 'salvaged-shelter-kit', 'description' => 'A rough starter home made from patched sheets and faction scrap. Owning one unlocks your Home area.', 'type' => 'home', 'icon_class' => 'fa-solid fa-house', 'inventory_slot_bonus' => 0, 'is_home' => true, 'price' => 260, 'required_role_type' => 'civilian', 'required_rank_id' => null, 'required_licence_id' => null, 'stock' => null],
