...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('stock_market_settings', function (Blueprint $table) {
            ...
            $table->decimal('max_trade_impact_percent', 5, 2)->default(99)->after('sell_impact_percent_per_100_shares');
            $table->unsignedInteger('crash_trade_threshold_shares')->default(100)->after('max_trade_impact_percent');
            $table->decimal('crash_extra_percent', 5, 2)->default(99)->after('crash_trade_threshold_shares');
        });
    }
